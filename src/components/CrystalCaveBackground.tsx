...
const CrystalShape = ({ width, height, variant }: { width: number; height: number; variant: number }) => {
  ...
  const gradStops = [
    { s1: "hsla(270,60%,75%,0.7)", s2: "hsla(270,50%,85%,0.4)", s3: "hsla(280,40%,90%,0.2)" },
    { s1: "hsla(260,55%,78%,0.65)", s2: "hsla(275,45%,82%,0.4)", s3: "hsla(290,35%,88%,0.2)" },
    { s1: "hsla(280,50%,76%,0.7)", s2: "hsla(265,55%,82%,0.35)", s3: "hsla(270,40%,90%,0.15)" },
    { s1: "hsla(270,65%,72%,0.6)", s2: "hsla(280,50%,80%,0.4)", s3: "hsla(260,40%,88%,0.2)" },
  ];
