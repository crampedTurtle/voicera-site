...
const TABS = [
  ...
  },
  {
    ...
    output: [
      { text: "Response 202 Accepted:", color: LIGHT_TEXT },
      { text: "", color: DARK_TEXT },
      { text: "{", color: DARK_TEXT },
      { text: '  "job_id": "3fa85f64-5717-4562-b3fc-2c963f66afa6",', color: BLUE, indent: 1 },
      { text: '  "status": "pending",', color: BLUE, indent: 1 },
      { text: '  "media_type": "audio",', color: BLUE, indent: 1 },
      { text: '  "message": "Job queued. Poll GET /api/v1/jobs/{job_id} for results.",', color: BLUE, indent: 1 },
      { text: '  "audio_child_job_id": null,', color: MID_TEXT, indent: 1 },
      { text: '  "video_child_job_id": null', color: MID_TEXT, indent: 1 },
      { text: "}", color: DARK_TEXT },
    ],
  },
  {
    ...
    code: [
      { text: "Request (video file required):", color: LIGHT_TEXT },
      { text: "", color: DARK_TEXT },
      { text: "POST /api/v1/analyze HTTP/1.1", color: DARK_TEXT },
      { text: "", color: DARK_TEXT },
      { text: "Host: api.example.com", color: BLUE },
      ...
      { text: 'Content-Disposition: form-data; name="media_type"', color: BLUE },
      { text: "", color: DARK_TEXT },
      { text: "video", color: DARK_TEXT },
      { text: "", color: DARK_TEXT },
      { text: "------7MA4YWxkTrZu0gW", color: LIGHT_TEXT },
      { text: 'Content-Disposition: form-data; name="file"; filename="interview.mov"', color: BLUE },
      { text: "Content-Type: video/quicktime", color: BLUE },
      { text: "", color: DARK_TEXT },
      { text: "(binary body omitted)", color: LIGHT_TEXT },
      { text: "", color: DARK_TEXT },
      { text: "------7MA4YWxkTrZu0gW--", color: LIGHT_TEXT },
    ...
    output: [
      ...
      { text: "", color: DARK_TEXT },
      { text: "{", color: DARK_TEXT },
      { text: '  "job_id": "8c1d9044-2a10-4f3e-9c11-0b2f6e7d8a90",', color: BLUE, indent: 1 },
      { text: '  "status": "pending",', color: BLUE, indent: 1 },
      { text: '  "media_type": "video",', color: BLUE, indent: 1 },
      { text: '  "message": "Job queued. Poll GET /api/v1/jobs/{job_id} for results.",', color: BLUE, indent: 1 },
      { text: '  "audio_child_job_id": null,', color: MID_TEXT, indent: 1 },
      { text: '  "video_child_job_id": null', color: MID_TEXT, indent: 1 },
      { text: "}", color: DARK_TEXT },
