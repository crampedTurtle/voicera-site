    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-8 items-center">
        ...
        <div className="max-lg:text-center max-lg:flex max-lg:flex-col max-lg:items-center max-lg:mt-[25px]">
          ...
          >
            AI-POWERED SINCERITY INTELLIGENCE
          </motion.span>
          ...
          >
            <button onClick={() => { trackEvent("cta_click", { cta_text: "Book a Demo", location: "hero" }); (window as any).Calendly?.initPopupWidget({ url: 'https://calendly.com/kevins-voicera-calendar/30min' }); }} className="gradient-bg px-8 py-3.5 type-button text-white rounded-xl hover:scale-[1.03] transition-all duration-200 hover:shadow-[0_4px_24px_rgba(99,102,241,0.35)] inline-flex items-center gap-2">
