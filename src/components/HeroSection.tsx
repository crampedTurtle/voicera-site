...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-[5fr_4fr] gap-8 items-center">
        {/* Left: Text content */}
        <div>
          <h1 className="type-hero mb-6 text-left" style={{ fontSize: "clamp(40px, 4.8vw, 64px)" }}>
            {words.map((word, i) => (
              <motion.span
                key={i}
