        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", gap: 64, alignItems: "center", flexWrap: "wrap" }}>
          ...
          <div style={{ flex: "1 1 400px", minWidth: 300 }}>
            <Reveal delay={0.2} dir="left">
              <div style={{ position: "relative", width: "100%", aspectRatio: "3/2", borderRadius: 16, overflow: "hidden" }}>
                <img src={hrVerticalImg} alt="Sincerity™ Embedded in Your Platform" style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }} />
                <div style={{ position: "absolute", top: 14, right: 14, padding: "5px 14px", borderRadius: 100, fontSize: 11, fontWeight: 700, letterSpacing: "0.06em", textTransform: "uppercase" as const, background: "#1d4ed8", color: "#ffffff", zIndex: 2 }}>Native Integration</div>
              </div>
            </Reveal>
          </div>
        </div>
          ...
          <div style={{ display: "flex", gap: 64, alignItems: "center", flexWrap: "wrap", flexDirection: "row-reverse" }}>
            ...
            <div style={{ flex: "1 1 400px", minWidth: 300 }}>
              <Reveal delay={0.15} dir="right">
                <a href="https://voicera.io/emotion-coachme/" target="_blank" rel="noopener noreferrer" style={{ display: "block", position: "relative", width: "100%", aspectRatio: "4/3", borderRadius: 16, overflow: "hidden" }}>
                  <img src={emotionCoachDetectionImg} alt="Emotion Coach Detection" style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }} />
                  <div style={{ position: "absolute", top: 14, right: 14, padding: "5px 14px", borderRadius: 100, fontSize: 11, fontWeight: 700, letterSpacing: "0.06em", textTransform: "uppercase" as const, background: "#1d4ed8", color: "#ffffff", zIndex: 2 }}>AI Analysis</div>
                </a>
              </Reveal>
            </div>
          </div>
