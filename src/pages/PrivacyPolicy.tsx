...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <JsonLd
        title="Privacy Policy — Voicera"
        description="Voicera's Privacy Policy describing our policies on the collection, use and disclosure of your information."
        path="/privacy-policy"
      />
      <Navbar />
      ...
      <section className="pt-44 pb-20 px-6">
        <div className="max-w-3xl mx-auto">
          <h1 className="type-display text-foreground mb-4">Privacy Policy</h1>
          <p className="text-muted-foreground mb-12">Last updated: August 20, 2024</p>
          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8
            ...
            <p>
              <strong>Please read this Privacy Policy carefully before using our Service. It is referenced and incorporated in Our{" "}
              <a href="https://voicera.io/terms-of-use/" target="_blank" rel="noopener noreferrer">Terms of Use</a>.</strong>
            </p>
            <p>This Privacy policy describes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service. It tells You about Your privacy rights and how the law protects You.</p>
            <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy.</p>

            <h2>Interpretation and Definitions</h2>

            <h3>Interpretation</h3>
            <p>The capitalized words herein have meanings defined in the next section and throughout the Policy. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
            ...
            <ul>
              ...
              <li><strong>Company</strong> (referred to as either "Voicera", "the Company", "We", "Us" or "Our" in this Agreement) refers to Voicera AI, Inc., 1920 Hillhurst Los Angeles, CA 90027. For the purpose of the GDPR, the Company is the Data Controller.</li>
              ...
              <li><strong>GDPR</strong> refers to the EU General Data Protection Regulation.</li>
              ...
              <li><strong>Website</strong> refers to Voicera's Internet web home and principal digital address, accessible from <a href="https://voicera.io" target="_blank" rel="noopener noreferrer">https://voicera.io</a>.</li>
              <li><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable. Under the GDPR, You can be referred to as the Data Subject or as the User as you are the individual using the Service.</li>
            </ul>

            <h2>Collecting and Using Your Personal Data</h2>

            <h3><em>Types of Data Collected</em></h3>
            ...
            <p>We use Cookies and similar tracking technologies to track the activity on Our Service and store certain information. Tracking technologies used are beacons, tags, and scripts to collect and track information and to improve and operate Our Service. The technologies We use may include:</p>
            <ul>
            ...
            <p>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. You can learn more about cookies in this <a href="https://www.termsfeed.com/blog/cookies/#What_Are_Cookies" target="_blank" rel="noopener noreferrer">TermsFeed website</a> article.</p>
            ...
            <div className="pl-4 border-l-2 border-border space-y-6">
              ...
              <div>
                ...
                <p>Type: Persistent Cookies · Administered by: Third-Parties</p>
            ...
            <p>Your information, including Personal Data, is processed by the Company in a secure environment and in such places where the parties involved in the processing are located. It means that this information may be transferred to — and maintained on — computers located outside of Your state, province, country or other governmental jurisdiction where the data protection laws may differ than those from Your jurisdiction.</p>
            ...
            <p>You may update, amend, or delete Your information at any time by signing in to Your Account, if you have one, and visiting the account settings section that allows you to manage Your personal information. You may also contact Us at <a href="mailto:support@voicera.io">support@voicera.io</a> to request access to, correct, or delete any personal information that You have provided to Us.</p>
            <p>Please note, however, that We may need to retain certain information when and where we have a legal obligation or lawful basis to do so.</p>
            ...
            <ul>
              <li><strong>Google Analytics</strong> — Google Analytics is a web analytics service offered by Google that tracks and reports website traffic. Google uses the data collected to track and monitor the use of our Service. This data is shared with other Google services. Google may use the collected data to contextualize and personalize the ads of its own advertising network. You can opt-out of having made your activity on the Service available to Google Analytics by installing the Google Analytics opt-out browser add-on. For more information on the privacy practices of Google, please visit the Google Privacy &amp; Terms web page: <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">https://policies.google.com/privacy</a></li>
            </ul>

            <h3>Email Marketing</h3>
            <p>We may use Your Personal Data to contact You with newsletters, marketing or promotional materials and other information that may be of interest to You. You may opt-out of receiving any, or all, of these communications from Us by following the unsubscribe link or instructions provided in any email We send or by contacting Us.</p>
            <p>We may use Email Marketing Service Providers to manage and send emails to You, including but not limited to:</p>
            <ul>
              <li><strong>Hubspot</strong> — Their Privacy Policy can be viewed at <a href="https://hubspot.com" target="_blank" rel="noopener noreferrer">https://hubspot.com</a></li>
              <li><strong>Brevo</strong> — Their Privacy Policy can be viewed at <a href="https://www.brevo.com" target="_blank" rel="noopener noreferrer">https://www.brevo.com</a></li>
            </ul>
            ...
            <div className="space-y-4">
              {[
                { cat: "Category A: Identifiers", examples: "A real name, alias, postal address, unique personal identifier, online identifier, Internet Protocol address, email address, account name, driver's license number, passport number, or other similar identifiers.", collected: "Yes" },
                { cat: "Category B: Personal information categories listed in the California Customer Records statute (Cal. Civ. Code § 1798.80(e))", examples: "A name, signature, Social Security number, physical characteristics or description, address, telephone number, passport number, driver's license or state identification card number, insurance policy number, education, employment, employment history, bank account number, credit card number, debit card number, or any other financial information, medical information, or health insurance information. Some personal information included in this category may overlap with other categories.", collected: "Yes" },
                { cat: "Category C: Protected classification characteristics under California or federal law", examples: "Age (40 years or older), race, color, ancestry, national origin, citizenship, religion or creed, marital status, medical condition, physical or mental disability, sex (including gender, gender identity, gender expression, pregnancy or childbirth and related medical conditions), sexual orientation, veteran or military status, genetic information (including familial genetic information).", collected: "No" },
                { cat: "Category D: Commercial information", examples: "Records and history of products or services purchased or considered.", collected: "No" },
                { cat: "Category E: Biometric information", examples: "Genetic, physiological, behavioral, and biological characteristics, or activity patterns used to extract a template or other identifier or identifying information, such as, fingerprints, faceprints, and voiceprints, iris or retina scans, keystroke, gait, or other physical patterns, and sleep, health, or exercise data.", collected: "No" },
                { cat: "Category F: Internet or other similar network activity", examples: "Interaction with our Service or advertisement.", collected: "Yes" },
                { cat: "Category G: Geolocation data", examples: "Approximate physical location.", collected: "No" },
                { cat: "Category H: Sensory data", examples: "Audio, electronic, visual, thermal, olfactory, or similar information.", collected: "No" },
                { cat: "Category I: Professional or employment-related information", examples: "Current or past job history or performance evaluations.", collected: "No" },
                { cat: "Category J: Non-public education information (per the Family Educational Rights and Privacy Act (20 U.S.C. Section 1232g, 34 C.F.R. Part 99))", examples: "Education records directly related to a student maintained by an educational institution or party acting on its behalf, such as grades, transcripts, class lists, student schedules, student identification codes, student financial information, or student disciplinary records.", collected: "No" },
                { cat: "Category K: Inferences drawn from other personal information", examples: "Profile reflecting a person's preferences, characteristics, psychological trends, predispositions, behavior, attitudes, intelligence, abilities, and aptitudes.", collected: "No" },
                { cat: "Category L: Sensitive personal information", examples: "Account login and password information, precise geolocation data.", collected: "Yes" },
              ].map((item) => (
                <div key={item.cat} className="bg-muted/50 rounded-lg p-4">
                  <p className="font-semibold text-foreground">{item.cat}</p>
                  <p className="text-sm mt-1">{item.examples}</p>
                  <p className="text-sm mt-1"><strong>Collected:</strong> {item.collected}</p>
                </div>
              ))}
            </div>

            <p>Under the CCPA/CPRA, personal information does not include:</p>
            <ul>
            ...
            <ul>
              <li><strong>Directly from You.</strong> For example, from the forms You complete on our Service, preferences You express or provide through our Service, or data that you upload to the Website.</li>
            ...
            <p>When We disclose personal information for a business purpose or a commercial purpose, We enter into a contract that describes the purpose and requires the recipient to both keep that personal information confidential and not use it for any purpose except performing our respective obligations under the terms of the contract.</p>
            ...
            <p>We do not sell personal information as the term sell is commonly understood. We may allow Service Providers to use Your personal information for the business purposes described in Our Privacy Policy, for activities such as advertising, marketing, and analytics, and these may be deemed a sale under CCPA/CPRA.</p>
            ...
            <p>We do not collect or sell the personal information of Consumers We actually know are less than 18 years of age. If You have reason to believe that a child under the age of 18 has provided Us with personal information, please contact Us with sufficient detail to enable Us to delete that information.</p>
            ...
            <ul>
              <li>By email: <a href="mailto:support@voicera.com">support@voicera.com</a></li>
              <li>By visiting this page on our website: <a href="https://voicera.io/contact-us/" target="_blank" rel="noopener noreferrer">https://voicera.io/contact-us/</a></li>
            </ul>
            ...
            <p>We will disclose and deliver the required information free of charge within forty-five (45) days of receiving Your verifiable request. The time period to provide the required information may be extended once by an additional forty-five (45) days when reasonably necessary and with prior notice.</p>
            ...
            <p>Our Service does not support Do Not Track signals.</p>
            ...
            <p>California Business and Professions Code Section 22581 allows California residents under the age of 18 who are registered users of online sites, services or applications to request and obtain removal of content or information they have publicly posted. We do not knowingly collect content or information, public or otherwise, from anyone under the age of 18.</p>
            <p>If you believe We have such data, you may request removal of such data, and if You are a California resident, You can contact Us using the contact information provided below, and include the email address associated with Your account.</p>
